...
@Component({
  selector: 'app-whiteboard2',
  imports: [CommonModule, FormsModule],
  templateUrl: './whiteboard2.component.html',
  styleUrl: './whiteboard2.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: {
    '(window:resize)': 'onWindowResize()',
  },
})
export class Whiteboard2Component {
  ...
  private pinchAnchorScreen: Point | null = null;
  ...
  private updatePinch(): void {
    const ids = Array.from(this.pointers.keys());
    if (ids.length !== 2 || !this.pinchActive || !this.pinchAnchorScreen || !this.pinchAnchorWorld)
      return;
    ...
    // Keep pinchAnchorWorld mapped to the initial screen anchor
